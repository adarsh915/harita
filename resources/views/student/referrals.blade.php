...
<div class="referral-grid">
        ...
        <div>
          ...
          <div class="referral-code-card">
            <h4 class="font-semibold" style="font-family: var(--font-serif); font-size: 1.1rem; color: var(--text-main);">My Referral Code</h4>
            ...
            <div class="card-body p-4">
              <form action="{{ route('student.referrals.store') }}" method="POST">
                ...
                <div class="form-group mb-3">
                  ...
                  <input type="email" name="referred_email" class="form-control" placeholder="eg. friend@example.com" required>
                </div>
                <div class="form-group mb-3">
          ...
          <div class="card-body p-3">
            <table class="table display responsive nowrap" id="refHistoryTable" style="width:100%">
              ...
              <tbody id="refHistoryBody">
                ...
                @empty
                <tr>
                  <td colspan="5" class="text-center text-muted py-4">No referrals submitted yet.</td>
                </tr>
                @endforelse
              </tbody>
            </table>
