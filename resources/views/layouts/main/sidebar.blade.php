@php
    ...
    if ($isInternal) {
        $navItems = [
            ...
            ['page' => 'demos', 'route' => 'admin.demos', 'label' => 'Demo Classes', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>', 'permission' => 'demos.view'],
        ...
        $navItems = [
            ['page' => 'dashboard', 'route' => 'teacher.dashboard', 'label' => 'Dashboard', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>', 'permission' => 'dashboard.view'],
            ...
            ['page' => 'leaves', 'route' => 'teacher.leaves', 'label' => 'Leaves', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>', 'permission' => 'leaves.view'],
            ['page' => 'payroll', 'route' => 'teacher.payroll', 'label' => 'Payroll', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>', 'permission' => 'payroll.view'],
            ['page' => 'feedbacks', 'route' => 'teacher.feedbacks', 'label' => 'Feedbacks', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>', 'permission' => 'feedbacks.view'],
        ...
        $navItems = [
            ['page' => 'dashboard', 'route' => 'student.dashboard', 'label' => 'Dashboard', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m3 9 9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z" /><polyline points="9 22 9 12 15 12 15 22" /></svg>', 'permission' => 'dashboard.view'],
            ...
            ['page' => 'feedbacks', 'route' => 'student.feedback', 'label' => 'Feedbacks', 'icon' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z" /></svg>', 'permission' => 'feedbacks.view'],
  ...
  <div class="sidebar-footer" style="padding: 1rem 0.75rem; display: flex; align-items: center; justify-content: space-between; gap: 0.5rem; border-top: 1px solid #f1f5f9;">
    <div class="sidebar-user-card" style="margin-bottom: 0; display: flex; align-items: center; gap: 0.5rem; flex: 1; min-width: 0;">
      ...
      <div class="sidebar-user-info" style="min-width: 0; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
        ...
        <div class="sidebar-user-role" style="font-size: 11px; color: var(--primary); text-transform: capitalize;">{{ $user->roles->pluck('name')->join(', ') ?: 'Staff' }}</div>
      </div>
    </div>
